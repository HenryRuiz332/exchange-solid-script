<footer id="footer" class="mt-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Políticas de Cookies</a></li>
            </ul>
          </div>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>SolidScript</span></strong>. Todos los derechos reservardos
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">SolidScript</a>
      </div>
    </div>
  </footer>