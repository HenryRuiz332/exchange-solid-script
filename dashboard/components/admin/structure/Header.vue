          ...
          <div class="iq-navbar-custom">
               ...
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <div class="navbar-left">
                        <!--  <ul id="topbar-data-icon" 
                              class="d-flex p-0 topbar-menu-icon" 
                              v-for="menu in computedheaders" 
                              :key="menu.text">
                              
                              <li >
                                   <router-link :to="menu.nvUrl"
                                   class="nav-link">
                                        <i :class="menu.icon"></i>
                                   </router-link>
                              </li>
                         ...
                         <ul id="topbar-data-icon" class="d-flex p-0 topbar-menu-icon">
                             <li  
                              v-for="menu,l in computedheaders" 
                              :key="menu.text">
                                <router-link :to="menu.nvUrl" class="nav-link font-weight-bold search-box-toggle"><i :class="menu.icon"></i></router-link>
                             </li>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <!-- <ul class="navbar-nav ml-auto navbar-list">
                         <li class="nav-item">
                           <a class="search-toggle iq-waves-effect language-title" href="#"> Links<i class="ri-arrow-down-s-line"></i></a>
                           <div class="iq-sub-dropdown">
                              <a class="iq-sub-card" href="/" target="_blanck">Tecnocosmetic site</a>
                           </div>
                        </li>
                        <li class="nav-item">
                  ...
                  <ul class="navbar-list">
                     <li>
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center bg-primary rounded">
                           <img src="/assets/images/undraw_Dev_focus_re_6iwt" alt="user">
                           <div class="caption">
                             <!--  <h6 class="mb-0 line-height text-white">{{authUser.name}}</h6> -->
                        ...
                        <div class="iq-sub-dropdown iq-user-dropdown">
                           <div class="iq-card shadow-none m-0">
                              <div class="iq-card-body p-0 ">
                                 <div class="bg-primary p-3">
                                   <!--  <h5 class="mb-0 text-white line-height">Hello {{authUser.name}}</h5> -->
...
<script>
     import { menu_sidebar } from '../../../api/app/menu_sidebar'
     export default{
          mixins: [menu_sidebar],
          components:{
