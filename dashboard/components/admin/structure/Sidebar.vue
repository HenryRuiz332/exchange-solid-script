   ...
   <div>
      <div class="iq-sidebar">
            <div class="iq-sidebar-logo d-flex justify-content-between">
               <router-link :to="'/dashboard/main/'+tokenMenu">
               <img src="images/logo.gif" class="img-fluid" alt="">
                  <span>{{ $attrs.AppName}}</span>
               </router-link>
            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu"  v-for="menu in computedheaders" :key="menu.text">
                     ...
                     <li>
                         <a :href="'#' + menu.idEvent" 
                              ...
                              aria-expanded="false">
                              <i :class="menu.icon"></i><span>{{ menu.menu }}</span>
                              <i class="ri-arrow-right-s-line iq-arrow-right"></i>
                         </a>
                         <ul class="iq-submenu collapse" 
                              ...
                              <li>
                                   <router-link :to="children.path">
                                        <i :class="children.icon"></i>{{ children.menu }}
                                   </router-link>
                              </li>
                         </ul>
                     </li>
