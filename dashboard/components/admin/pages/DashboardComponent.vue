           ...
           <div class="iq-card iq-card-block iq-card-stretch iq-card-height-half">
              <div class="iq-card-body p-0">
                 ...
                 <div class="d-flex align-items-center pb-3">
                    <div class="col-lg-6">
                       <div class="ml-2">
                          <h5 class="mb-1">Pages visited   {{visitors}}</h5>
                     ...
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-body">
                           <div class="d-flex align-items-center justify-content-between text-right">
                              ...
                              <div>
                                 <h5 class="mb-0">Pages Visited</h5>
                                 <span class="h4 text-primary mb-0 counter d-inline-block w-100">{{ visitors }}</span>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="iq-card-body">
                           <div class="d-flex align-items-center justify-content-between text-right">
                              ...
                              <div>
                                 ...
                                 <span class="h4 text-success mb-0 counter d-inline-block w-100">{{ usersRegistered }}</span>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="iq-card-body">
                           <div class="d-flex align-items-center justify-content-between text-right">
                              ...
                              <div>
                                 ...
                                 <span class="h4 text-danger mb-0 counter d-inline-block w-100">5</span>
                              </div>
                           </div>
                        </div>
                     </div>
